...
public class CourseDao {
    ...
    /**
     * If the new day date is left empty, replace it with java.sql.Date.valueOf("1900-01-01") to left it unchanged.
     */
    ...
    /**
     * Select a list of courses verifying conditions.
     * If filtering, the school year must be selected.
     * Attempt to use dynamic parameters for SQL request
     */
