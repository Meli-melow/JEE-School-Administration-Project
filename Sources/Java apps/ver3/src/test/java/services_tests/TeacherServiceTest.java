...
public class TeacherServiceTest {
    ...
    public void serviceCreateTeacher() {
        ts.createTeacher( new Teacher("Éric", "LECHAMP", "eric.lechamp@cyu.fr", "gfcgctr", "Data Exploration"));
        assertSame(true, ts.getTeacherById(1).equals(
                        new Teacher("Éric", "LECHAMP", "eric.lechamp@cyu.fr", "gfcgctr",
                                "Data Exploration"), 1));
    }

    @Test //TODO: WORKS
    public void serviceLoginTeacher() {
        t = ts.teacherLogin("alain.leclair@cyu.fr", "fzgb");
        assertSame(true, t == null);
        /*assertSame(true, t.equals( new Teacher("Alain",  "LECLAIR", "alain.leclair@cyu.fr",
    ...
    public void serviceFetchTeacherById() {
        ...
        assertSame(true, t.equals( new Teacher("Éric", "LECHAMP", "eric.lechamp@cyu.fr",
                "gfcgctr", "Data Exploration"),1));
        /*assertSame(t.equals( new Teacher("Alain",  "LECLAIR", "alain.leclair@cyu.fr",
                "alLE", "Maths"),1), true);*/
    }
