...
<div class="container">
  ...
  <%
    ...
    courses.add(new Course("Sciences", Date.valueOf("2024-12-05"), "14:00", "02:00", "Physique", "ING1", null)); // Jeudi
    courses.add(new Course("Sciences", Date.valueOf("2024-12-06"), "10:00", "02:00", "Chimie", "ING1", null)); // Vendredi
    ...
    <div class="schedule-day">
      ...
      <ul>
        ...
        <li>
          ...
          <%= course.getHour() %> - Durée : <%= course.getDuration() %>
        </li>
        <% } %>
      </ul>
      <% } %>
